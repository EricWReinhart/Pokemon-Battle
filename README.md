...
git clone https://github.com/EricWReinhart/Pokemon-Battle.git<br>
*A folder named 'Pokemon-Battle' should have been created. Navigate into this folder and run the following command:<br>*
gradle wrapper<br>
